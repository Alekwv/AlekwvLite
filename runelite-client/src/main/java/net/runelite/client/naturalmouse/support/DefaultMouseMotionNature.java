...
import net.runelite.client.naturalmouse.api.SystemCalls;

import java.awt.*;
import java.util.Random;

import static net.runelite.client.naturalmouse.support.DefaultNoiseProvider.DEFAULT_NOISINESS_DIVIDER;
import static net.runelite.client.naturalmouse.support.SinusoidalDeviationProvider.DEFAULT_SLOPE_DIVIDER;
