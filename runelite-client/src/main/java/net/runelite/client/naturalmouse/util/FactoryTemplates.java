package net.runelite.client.naturalmouse.util;

import net.runelite.client.naturalmouse.api.MouseMotionFactory;
import net.runelite.client.naturalmouse.api.SpeedManager;
import net.runelite.client.naturalmouse.support.DefaultMouseMotionNature;
