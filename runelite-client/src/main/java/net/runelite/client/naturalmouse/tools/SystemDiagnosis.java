package net.runelite.client.naturalmouse.tools;

import net.runelite.client.naturalmouse.api.MouseInfoAccessor;
import net.runelite.client.naturalmouse.api.SystemCalls;
import net.runelite.client.naturalmouse.support.DefaultMouseInfoAccessor;
import net.runelite.client.naturalmouse.support.DefaultSystemCalls;
