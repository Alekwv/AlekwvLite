...
import net.runelite.client.naturalmouse.support.DoublePoint;
import net.runelite.client.naturalmouse.support.Flow;
import net.runelite.client.naturalmouse.support.MouseMotionNature;
import net.runelite.client.naturalmouse.support.mousemotion.Movement;
import net.runelite.client.naturalmouse.support.mousemotion.MovementFactory;
import net.runelite.client.naturalmouse.util.MathUtil;
